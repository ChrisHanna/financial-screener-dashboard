...
function renderTickersGrid(data) {
    ...
    Object.entries(data.results).forEach(([ticker, tickerData]) => {
        ...
        // Get last Analyzer B signals with dates for timing display
        const analyzerBSignals = findLastAnalyzerBSignals(tickerData);
                ...
                <div class="oscillators-dashboard">
                    ...
                    <div class="oscillator-section analyzer-b" style="border-left: 4px solid ${analyzerBState.color};">
                        ...
                        <div class="oscillator-values">
                            ...
                            <div class="value-item signal-timing">
                                <span>Last Signal:</span> <span style="color: ${getSignalColor(analyzerBSignals.mostRecentSignalType)}; font-weight: bold;">${analyzerBSignals.mostRecentSignalType}</span>
                            </div>
                            <div class="value-item signal-timing">
                                <span>Signal Date:</span> <span style="color: ${analyzerBSignals.daysSinceMostRecent <= 5 ? '#FFD700' : '#808080'}; font-size: 0.9em;">${formatSignalDate(analyzerBSignals.mostRecentSignal, analyzerBSignals.daysSinceMostRecent)}</span>
                            </div>
                            ` : `
                            <div class="value-item">
                                <span style="color: #808080; font-size: 0.9em;">No recent signals</span>
                            </div>
                            `}
                        </div>
                    ...
                    <div class="oscillator-section rsi3m3" style="border-left: 4px solid ${currentRSI3M3StateInfo.color}; background: ${currentRSI3M3StateInfo.color}15;">
                        ...
                        <div class="oscillator-values">
                            ...
                            <div class="value-item transition-info">
                                <span>Transition Date:</span> <span style="color: ${rsi3m3StateChange.daysSinceChange <= 5 ? '#FFD700' : '#808080'}; font-size: 0.9em;">${formatSignalDate(rsi3m3StateChange.lastChange, rsi3m3StateChange.daysSinceChange)}</span>
                            </div>
                            ${isFreshRSI3M3Signal ? `
                            <div class="value-item transition-info">
                            ...
                            ` : `
                            <div class="value-item">
                                <span style="color: #808080; font-size: 0.9em;">No recent state changes</span>
                            </div>
                            `}
                        </div>
                        <div class="signal-indicators">
                        ...
                        <div style="flex-grow: 1;">
                            <div style="display: flex; justify-content-between; align-items: center;">
                                ...
                                <div style="text-align: right;">
                                    <div style="color: #ccc; font-size: 0.9em;">${formatSignalDate(signal.date, signal.daysSince)}</div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 20px;">
                    ...
                    <div>
                        ...
                        <small style="color: ${analyzerBSignals.daysSinceMostRecent <= 5 ? '#FFD700' : '#808080'};">
                            ${formatSignalDate(analyzerBSignals.mostRecentSignal, analyzerBSignals.daysSinceMostRecent)}
                        </small></p>
